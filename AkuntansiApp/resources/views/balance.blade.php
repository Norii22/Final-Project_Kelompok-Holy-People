    ...
    <div class="row column1">
        ...
        <div class="col-md-6">
            <div class="white_shd full margin_bottom_30">
                <h3 class="text-center pt-5">Balance</h3>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><span class="float-left">$</span><span class="float-right">{{$list_tsc[count($list_tsc) - 1]->balance}}</span></td>
                                    <td><span class="float-left">$</span><span class="float-right">0</span></td>
                                    <?php $deb += $list_tsc[count($list_tsc) - 1]->balance;?>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><span class="float-left">$</span><span class="float-right">0</span></td>
                                    <?php $deb += ($total_land + $total_building);?>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><span class="float-left">$</span><span class="float-right">0</span></td>
                                    <td><span class="float-left">$</span><span class="float-right">{{$list_tsc[0]->balance - $total_banksloan}}</span></td>
                                </tr>
                                <?php $cred += $list_tsc[0]->balance;?>
                            </tbody>
                            <tfoot>
                                <tr>
